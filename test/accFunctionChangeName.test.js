...
test('Test 2: empty firstname',async () => {
    let res = await user1.post(domain+"/account/name").send({ lastName:"last",password:"1234" });
    let text = res.text
    expect(isJson(text)).toBeTruthy();
    let obj  = JSON.parse(text);
    expect(obj.success).toBeFalsy();
...
test('Test 3: empty lastname',async () => {
    let res = await user1.post(domain+"/account/name").send({ firstName:"firstname",password:"1234" });
    let text = res.text
    expect(isJson(text)).toBeTruthy();
    let obj  = JSON.parse(text);
    expect(obj.success).toBeFalsy();
...
test('Test 4: invalid firstname type',async () => {
    let res = await user1.post(domain+"/account/name").send({firstName:1234, lastName:"last",password:"1234" });
    let text = res.text
    expect(isJson(text)).toBeTruthy();
    let obj  = JSON.parse(text);
    expect(obj.success).toBeFalsy();
...
test('Test 5: invalid lastname type',async () => {
    let res = await user1.post(domain+"/account/name").send({firstName:"firstname", lastName:12345,password:"1234" });
    let text = res.text
    expect(isJson(text)).toBeTruthy();
    let obj  = JSON.parse(text);
    expect(obj.success).toBeFalsy();
...
test('Test 7: invalid password matching',async () => {
    let res = await user1.post(domain+"/account/name").send({firstName:"harshana", lastName:"eranda",password:"password2" });
    let text = res.text;
    expect(isJson(text)).toBeTruthy();
    let obj  = JSON.parse(text);
    expect(obj.success).toBeFalsy();
...
test('Test 8: valid password',async () => {
    let res = await user1.post(domain+"/account/name").send({firstName:"harshana", lastName:"eranda",password:"password" });
    let text = res.text
    expect(isJson(text)).toBeTruthy();
    let obj  = JSON.parse(text);
